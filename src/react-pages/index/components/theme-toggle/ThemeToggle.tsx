...
module.exports = function ThemeToggle() {
    ...
    return <>
        {<ThemeToggleStyle/>}
        <input id={'theme-toggle-'+toggleID} type={'checkbox'} className={"theme-toggle__checkbox"}/>
        <label htmlFor={'theme-toggle-'+toggleID} className="theme-toggle">
            <span className="theme-toggle__icon-1">
            ...
            <span className="theme-toggle__icon-2">
