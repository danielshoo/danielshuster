...
module.exports = () => {
    return <section className={'dsr-key-skills'}>
        <div className={'dsr-key-skills__banner'}>
            <span className={'dsr-key-skills__banner-text'}>Key Skills</span>
            <svg className={'dsr-key-skills__banner-icon'} xmlns="http://www.w3.org/2000/svg" width="24" height="23" fill="none" viewBox="0 0 24 23">
        ...
        <label htmlFor={'key-skills--1'} className={'dsr-key-skills__display-toggle'}>Languages</label>
        ...
        <label htmlFor={'key-skills--2'} className={'dsr-key-skills__display-toggle'}>Frameworks</label>
        ...
        <label htmlFor={'key-skills--3'} className={'dsr-key-skills__display-toggle'}>Paradigms</label>
        ...
        <label htmlFor={'key-skills--4'} className={'dsr-key-skills__display-toggle'}>Testing</label>
        ...
        <label htmlFor={'key-skills--5'} className={'dsr-key-skills__display-toggle'}>Database</label>
        ...
        <label htmlFor={'key-skills--6'} className={'dsr-key-skills__display-toggle'}>Version Control</label>
...
module.exports.Style = () => <style>{keySkillsCSS}</style>;