...
module.exports = (props) => {
    ...
    return <section className={rootClassname}>
        ...
        <p className={'dsr-pro-summary__summary'}>
            I am a Full Stack Web Developer with a bachelors in Computer Science and 10+ years experience. My current area of focus is frontend, mobile, and desktop application development, though I have expertise on the LAMP stack as well. As a Lead Frontend Engineer, I frequently collaborate with UX and product managers in order to finalize designs, scope efforts, and realize business goals. Along the way I will be utilizing coding best practices, leaning on industry standards, and implementing clean code & architecture. When Web Development is not involved, I'm busy being a full time cat dad, wood-working enthusiast, trail hiker, and dungeon master.
        </p>
    </section>;
};
